...
class Sarsa(Base):
    def __init__(self, num_epoch=20000, gamma=0.98, steps_total=300, num_angle=200, num_angle_v=200, lr=0.9, eps=0.9):
        super().__init__('results/sarsa/train.log', num_epoch, gamma, steps_total, num_angle, num_angle_v, lr, eps)
        self.qw_path = f'results/sarsa/QValues.npy'
        self.track_path = f'results/sarsa/QTrack.txt'
        self.log_path = 'results/sarsa/train.log'
        self.name = 'sarsa算法'
    ...
    def visualizeAction(self, file_path='results/sarsa/QValues.npy'):
        """
        可视化动作
        :return:
        """
