...
from myenv.gym_ai import GymAI
...
class FightingiceEnv(gym.Env):
    ...
    def __init__(self, **kwargs):
        ...
        _actions = "AIR_A AIR_B AIR_D_DB_BA AIR_D_DB_BB AIR_D_DF_FA AIR_D_DF_FB AIR_DA AIR_DB AIR_F_D_DFA AIR_F_D_DFB AIR_FA AIR_FB AIR_UA AIR_UB BACK_JUMP BACK_· CROUCH_A CROUCH_B CROUCH_FA CROUCH_FB CROUCH_GUARD DASH FOR_JUMP FORWARD_WALK JUMP NEUTRAL STAND_A STAND_B STAND_D_DB_BA STAND_D_DB_BB STAND_D_DF_FA STAND_D_DF_FB STAND_D_DF_FC STAND_F_D_DFA STAND_F_D_DFB STAND_FA STAND_FB STAND_GUARD THROW_A THROW_B"
    ...
    def reset(self, p2="MctsAi"): # BC P MctsAi
    ...
    def step(self, action):
        ...
        if self.pipe.poll(60):
            ...
            print("can't receive signals within 60 seconds. let's terminate gym env.")
