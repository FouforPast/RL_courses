...
from src.dqn import PrintCallback, MyEvaluateCallback
...
def train(episode=options.episode):
    ...
    eval_cb = MyEvaluateCallback(10)
    cbs = [loss_cb, ckpt_cb, eval_cb]
    dqn_session.run(class_type=DQNTrainer, episode=1000, params=config.trainer_params, callbacks=cbs)
