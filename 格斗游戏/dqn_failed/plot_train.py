...
# plt.show()
plt.savefig('png_file/fail_dqn_hp_train.png')
...
# plt.show()
plt.savefig('png_file/fail_dqn_reward_train.png')
...
plt.ylabel('loss')
# plt.show()
plt.savefig('png_file/fail_dqn_loss_train.png')
...
# plt.show()
plt.savefig('png_file/fail_dqn_hp_val.png')
...
# plt.show()
plt.savefig('png_file/fail_dqn_reward_val.png')
...
# plt.show()
plt.savefig('png_file/fail_dqn_win_prob_train.png')
...
plt.legend()
# plt.show()
plt.savefig('png_file/fail_dqn_win_prob_val.png')