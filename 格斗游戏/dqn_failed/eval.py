...
parser.add_argument('--ckpt_path', type=str, default=r'/app/mindspore_dqn2/ckpt/policy_net1/policy_net_1000.ckpt', help='The ckpt file in eval.')
...
def dqn_eval():
    ...
    """
    self.msrl.actors.evaluate_policy._input_network
    list(self.trainable_variables()['policy_net'].parameters_and_names())[0][1].T
    list(self.msrl.actors.evaluate_policy._input_network.parameters_and_names())[0][1].T
    """
